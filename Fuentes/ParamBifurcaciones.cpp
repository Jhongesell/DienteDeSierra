...
__fastcall TVCap_Bifurcaciones::TVCap_Bifurcaciones(TComponent* Owner) : TForm(Owner)
{
   Aceptar = false;
}

// Al presionar el boton de acptar
void __fastcall TVCap_Bifurcaciones::Button1Click(TObject *Sender)
{
   Aceptar = true;
   Close();        
}
...
// Cambio de color
void __fastcall TVCap_Bifurcaciones::Panel5Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Bifurcaciones::Panel6Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Bifurcaciones::Panel7Click(TObject *Sender)
{
...
// Cambio de color
void __fastcall TVCap_Bifurcaciones::Panel8Click(TObject *Sender)
{
...
void __fastcall TVCap_Bifurcaciones::ListBoxParametrosClick(TObject *Sender)
{
...
void __fastcall TVCap_Bifurcaciones::EditValorParametroKeyPress(TObject *Sender, char &Key)
{
   if (Key == VK_RETURN) {
      Key = 0;
...
void __fastcall TVCap_Bifurcaciones::CheckBox5Click(TObject *Sender)
{
   TituloCondicionInicial->Visible = !CheckBox5->Checked;
   Edit14->Visible = !CheckBox5->Checked;
}
//---------------------------------------------------------------------------
