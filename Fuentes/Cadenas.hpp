...
//////////////////////////////////////////////////////////////////////////////
//                                                                          //
// Rutinas de manupulacion cadenas                                          //
//                                                                          //
//////////////////////////////////////////////////////////////////////////////
...
class Cadenas 
{
   ...
   public:
                       ...
                       // Asigna un puntero que contiene la cadena CAD
      ...
      int              Posicion_palabra_siguiente(const char *cad, const unsigned int pos, const unsigned int t_p);
                       ...
                       // Compara la cadena CAD1 con la cadena CAD2 regresando 1 si son iguales, en caso contrario regresa 0
      int              Compara(const char *cad1, const char *cad2);
      ...
      int              Es_caracter_alfnumerico(const char car);
                       ...
                       // Rutina que retorna verdadero si la cadena s¢lo contiene una expresion numerica valida (ya sea en formato exponencial o numerico ordinario) en caso contrario retorna (0)
...
//                       // Indica el estado la clase
//      unsigned int     Estado; 
//                       // Retorna el estado de la clase
//      unsigned int     Retorna_estado(void)
//                       {return Estado;}
